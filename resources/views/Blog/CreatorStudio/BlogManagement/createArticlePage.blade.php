        ...
        <div class="mb-3">
            <form action="{{ route('article.create') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <select class="form-select" name="category_id" id="category" required style="width: 100%; padding: 8px">
                ...
                <div class="d-flex justify-content-center mt-5">
                    <img src="{{ asset('Photos/nophotoArticle.jpg') }}" id="previewImage" class="rounded-sm shadow-lg"
