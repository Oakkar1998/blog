                ...
                <nav class="navbar navbar-light navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                        ...
                        <div class="dropdown mx-3">
                            <button type="button"
                                class="btn btn-outline-dark rounded-circle border-dark position-relative" id="notiBell"
                                data-bs-toggle="dropdown" aria-expanded="false" style="width: 48px; height: 48px;">
                                    ...
                                    <li class="mb-2 noti-item {{ $isHidden ? 'd-none more-noti' : '' }}">
                                        <div
                                            ...
                                            <div class="flex-grow-1">
                                                <div>
                                                    <span
                                                        class="d-block">{{ $notification->data['actor_name'] ?? 'Someone' }}
